(function () { function a(a, b, c) { return "#" + ((256 + a << 8 | b) << 8 | c).toString(16).slice(1); } function b(a, b, c) { return [a[0] * (1 - c) + b[0] * c, a[1] * (1 - c) + b[1] * c, a[2] * (1 - c) + b[2] * c]; } !~navigator.platform.indexOf("Linux") || $("body").addClass("etc"); var c = 200, d = 120, e, f, g = [[228, 114, 42], [178, 47, 18], [237, 146, 40], [26, 155, 126]]; for (var h = 0, i = 0; i < screen.height; h++, i += e + 2) {
